...
* `git clone --depth 1 git@github.com:***.git new-project && cd new-project` - клонируем в папку `new-project` и переход в неё.
...
[Ссылка на оригинал](https://github.com/CSSSR/sputnik/blob/master/docs/Git/Readme.md)